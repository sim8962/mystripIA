...
class CardVolPdfCompare extends StatelessWidget {
  const CardVolPdfCompare({super.key, required this.volPdf});

  final VolPdf volPdf;

  @override
  Widget build(BuildContext context) {
    // Convert VolPdf to VolModel for display
    final vol = VolModel.fromVolPdf(volPdf);
    ...
    return Row(
      children: [
        ...
        Container(
          ...
          child: Row(
            ...
            children: [
              ...
              Container(width: 5, color: _getTypeColor(vol)),
            ],
          ),
        ),
        // Type icon
        Container(
          ...
          child: CircleAvatar(
            backgroundColor: _getTypeColor(vol),
            child: Text(
        ...
        Expanded(
          child: Column(
            ...
            children: [
              // Date label
              Text(_getDateLabel(vol), style: AppStylingConstant.dateLabelStyle, overflow: TextOverflow.fade),
  ...
  Color _getTypeColor(VolModel vol) {
